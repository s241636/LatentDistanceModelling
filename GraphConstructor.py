...
def construct_random(data: torch.Tensor, n_neighbors: int) -> np.ndarray:
    """
...
def construct_knn(data: torch.Tensor, k_neighbors: int, undirected: bool = False) -> torch.Tensor:
    """
